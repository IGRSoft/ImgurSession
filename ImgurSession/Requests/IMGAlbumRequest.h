 ...
 */
+ (void)updateAlbumWithID:(NSString*)albumID imageIDs:(NSArray *)imageIDs success:(void (^)(void))success failure:(void (^)(NSError * error))failure;
/**
 Update an anon album with optional params.
 */
+ (void)updateAlbumWithID:(NSString*)albumID title:(NSString *)title description:(NSString *)description imageIDs:(NSArray *)imageIDs privacy:(IMGAlbumPrivacy)privacy layout:(IMGAlbumLayout)layout cover:(NSString *)coverID success:(void (^)(void))success failure:(void (^)(NSError * error))failure;
 ...
 */
+ (void)deleteAlbumWithID:(NSString *)albumID success:(void (^)(void))success failure:(void (^)(NSError *error))failure;
/**
